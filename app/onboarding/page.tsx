...
export default function OnboardingPage() {
  ...
  const renderStepContent = () => {
    ...
    case 3:
      return (
        <div className="space-y-6">
          <p className="text-gray-600">Add your bank account information to receive payouts from donations.</p>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
            <p className="text-sm text-yellow-800">
              <strong>Important:</strong> Make sure the account holder name matches your registered name exactly. This
                information will be used for identity verification.
            </p>
          </div>
        </div>
      );
    ...
    case 4:
      return (
        <div className="space-y-6">
          <p className="text-gray-600">Set up real-time donation alerts for your streams and content.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">Add donation alerts to your OBS streaming setup</p>
              <Button
                variant="outline"
                className="w-full"
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">Embeddable widget for your website or social media</p>
              <Button
                variant="outline"
                className="w-full"
          ...
          <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>Pro Tip:</strong> You can customize your donation alerts with different themes, animations, and
                sounds to match your branding!
            </p>
          </div>
        </div>
      );
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Welcome to SocialBuzz!</h1>
          <p className="text-lg text-gray-600">Let&apos;s set up your creator profile in just a few steps</p>
        </div>
